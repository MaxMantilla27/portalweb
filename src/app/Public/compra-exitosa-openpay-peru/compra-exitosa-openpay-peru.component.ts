...
@Component({
  selector: 'app-compra-exitosa-openpay-peru',
  templateUrl: './compra-exitosa-openpay-peru.component.html',
  styleUrls: ['./compra-exitosa-openpay-peru.component.scss']
})
export class CompraExitosaOpenpayPeruComponent implements OnInit {
