...
@Component({
  selector: 'app-pago-multipago',
  templateUrl: './pago-multipago.component.html',
  styleUrls: ['./pago-multipago.component.scss']
})
export class PagoMultipagoComponent implements OnInit {
