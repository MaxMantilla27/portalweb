...
export class ConfirmacionPagoOpenpayPeruComponent implements OnInit {
  ...
  OpenPayInit() {
    OpenPayPeru.setId('momoj94bmepe1pmubupx');
    OpenPayPeru.setApiKey('pk_adaaac28202241d6a979341a0d463809');
    OpenPayPeru.setSandboxMode(true);
    var deviceSessionId = OpenPayPeru.deviceData.setup('fomrOpenPAy');
    console.log(OpenPayPeru.getSandboxMode());
