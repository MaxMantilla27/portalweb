...
import { PEspecificoCarreraExamenPreguntaAlternativaDTO, PEspecificoCarreraExamenPreguntaFileDTO } from 'src/app/Core/Models/PEspecificoCarreraExamenDTO';
import { PEspecificoEsquemaService } from 'src/app/Core/Shared/Services/PEspecificoEsquema/pespecifico-esquema.service';
import { SnackBarServiceService } from 'src/app/Core/Shared/Services/SnackBarService/snack-bar-service.service';

@Component({
  selector: 'app-modal-examen-aplicacion-preguntas',
  templateUrl: './modal-examen-aplicacion-preguntas.component.html',
  styleUrls: ['./modal-examen-aplicacion-preguntas.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ModalExamenAplicacionPreguntasComponent implements OnInit ,OnDestroy {
  ...
  constructor(
    public dialogRef: MatDialogRef<ModalExamenAplicacionPreguntasComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private _PEspecificoEsquemaService: PEspecificoEsquemaService,
    private _SnackBarServiceService:SnackBarServiceService
    ) { }
  public pregunta:PEspecificoCarreraExamenPreguntaFileDTO={
    Id:0,
    IdPreguntaTipo:0,
    Enunciado:'' ,
    Descripcion:'' ,
