...
@Component({
  selector: 'app-curso-modulos-carreras-profesionales',
  templateUrl: './curso-modulos-carreras-profesionales.component.html',
  styleUrls: ['./curso-modulos-carreras-profesionales.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class CursoModulosCarrerasProfesionalesComponent implements OnInit, OnChanges,OnDestroy {
  ...
  AddProgresToProgramV2() {
    ...
    this.programEstructura.listaCursoMatriculado.forEach((program:any) => {
      cantidad=0
      cantidadRealizada=0
