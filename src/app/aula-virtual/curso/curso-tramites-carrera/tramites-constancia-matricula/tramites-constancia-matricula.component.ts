...
@Component({
  selector: 'app-tramites-constancia-matricula',
  templateUrl: './tramites-constancia-matricula.component.html',
  styleUrls: ['./tramites-constancia-matricula.component.scss']
})
export class TramitesConstanciaMatriculaComponent implements OnInit ,OnDestroy {
