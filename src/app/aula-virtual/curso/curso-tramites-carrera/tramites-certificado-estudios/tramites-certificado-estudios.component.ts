...
@Component({
  selector: 'app-tramites-certificado-estudios',
  templateUrl: './tramites-certificado-estudios.component.html',
  styleUrls: ['./tramites-certificado-estudios.component.scss']
})
export class TramitesCertificadoEstudiosComponent implements OnInit ,OnDestroy {
