...
export class TramitesGradoBachillerComponent implements OnInit,OnDestroy {
  ...
  public CertificadoEstudiosCompletado=false;
  public DeudasPendientes=false;
  public CertificadoIdiomaCompletado=false;
  ...
  ValidarInformacionActualizada(){
    this._DatosPerfilService.ValidarInformacionActualizada(this.IdMatriculaCabecera).pipe(takeUntil(this.signal$)).subscribe({
      ...
      complete:()=>{
        this.ValidarCertificadoEstudiosCompletado()
      }
    })
  }
  ValidarCertificadoEstudiosCompletado(){
    this._DatosPerfilService.ValidarCertificadoEstudiosCompletado(this.IdMatriculaCabecera).pipe(takeUntil(this.signal$)).subscribe({
      next:x=>{
        this.CertificadoEstudiosCompletado=x;
      },
      complete:()=>{
  ...
  ObtenerCertificadoIdiomaAlumno(){
    this._DatosPerfilService.ValidarCertificadoIdiomaAprobado(this.IdMatriculaCabecera).pipe(takeUntil(this.signal$)).subscribe({
      next:x=>{
        this.CertificadoIdiomaCompletado=x;
      },
      complete:()=>{
        this.PagoActivo()
      }
  ...
  PagoActivo(){
    if(this.InformacionActualizada && this.CertificadoEstudiosCompletado && this.DeudasPendientes && this.CertificadoIdiomaCompletado){
