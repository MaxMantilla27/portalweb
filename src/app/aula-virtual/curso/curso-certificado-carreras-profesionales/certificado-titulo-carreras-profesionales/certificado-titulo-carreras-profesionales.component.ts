...
import { ModalCertificadoTituloCarrerasProfesionalesComponent } from './modal-certificado-certificado-titulo-carreras-profesionales/modal-certificado-titulo-carreras-profesionales.component';
import { MatDialog } from '@angular/material/dialog';


@Component({
  selector: 'app-certificado-titulo-carreras-profesionales',
  templateUrl: './certificado-titulo-carreras-profesionales.component.html',
  styleUrls: ['./certificado-titulo-carreras-profesionales.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class CertificadoTituloCarrerasProfesionalesComponent implements OnInit,OnDestroy ,OnChanges {
  ...
  RegistrarCertificadoFisico(data:any){
    const dialogRef = this.dialog.open(ModalCertificadoTituloCarrerasProfesionalesComponent, {
      width: '600px',
      data: data,
