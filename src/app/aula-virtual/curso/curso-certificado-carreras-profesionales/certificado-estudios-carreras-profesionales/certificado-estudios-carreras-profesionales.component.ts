...
import { ModalCertificadoEstudiosCarrerasProfesionalesComponent } from './modal-certificado-estudios-carreras-profesionales/modal-certificado-estudios-carreras-profesionales.component';


@Component({
  selector: 'app-certificado-estudios-carreras-profesionales',
  templateUrl: './certificado-estudios-carreras-profesionales.component.html',
  styleUrls: ['./certificado-estudios-carreras-profesionales.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class CertificadoEstudiosCarrerasProfesionalesComponent implements OnInit,OnDestroy ,OnChanges {
