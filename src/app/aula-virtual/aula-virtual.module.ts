...
import { CursoConfiguracionResumenComponent } from './curso/curso-configuracion-resumen/curso-configuracion-resumen/curso-configuracion-resumen.component';
...
@NgModule({
  declarations: [
    ...
    CursoConfiguracionResumenComponent,
