  ...
  IrVideo(url:string,habilitado:boolean,capitulo:number){
    ...
    if(capitulo==1){
      if(habilitado){
        ...
        this._SnackBarServiceService.openSnackBar("Debes completar el video anterior para continuar",'x',10,"snackbarCrucigramaerror");
      }
    }
    else{
      this._SnackBarServiceService.openSnackBar("No tienes acceso",'x',20,"snackbarCrucigramaerror");
    }
  }
