...
import { DocenciaGestionSilabosRegistroAddComponent } from './docencia-gestion-silabos-registro-add/docencia-gestion-silabos-registro-add.component';

@Component({
  selector: 'app-docencia-gestion-silabos-registro',
  templateUrl: './docencia-gestion-silabos-registro.component.html',
  styleUrls: ['./docencia-gestion-silabos-registro.component.scss'],
...
export class DocenciaGestionSilabosRegistroComponent implements OnInit {
  ...
  asdas(){
    console.log(this.contenido.Bibliografia)
  }
