...
@Component({
  selector: 'app-docencia-gestion-silabos-registro-add',
  templateUrl: './docencia-gestion-silabos-registro-add.component.html',
  styleUrls: ['./docencia-gestion-silabos-registro-add.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class DocenciaGestionSilabosRegistroAddComponent implements OnInit ,OnDestroy{

  private signal$ = new Subject();
  constructor(
    public dialogRef: MatDialogRef<DocenciaGestionSilabosRegistroAddComponent>,
