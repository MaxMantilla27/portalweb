...
@Component({
  selector: 'app-formulario-naranja',
  templateUrl: './formulario-naranja.component.html',
  styleUrls: ['./formulario-naranja.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class FormularioNaranjaComponent implements OnChanges, OnInit,OnDestroy {
