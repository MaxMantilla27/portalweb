      ...
      if (tipoPagina === 'index' || tipoPagina === 'curso' || tipoPagina === 'blog' || tipoPagina === 'whitepaper') {
        this.dialog.open(FormularioProgressiveProfilingComponent, {
          ...
          data: {
            ...
            cabeceraMensajeSupIndexCurso: formulario.cabeceraMensajeSupIndexCurso,
            cabeceraMensajeSupTexto: formulario.cabeceraMensajeSupTexto,
            cabeceraMensajeSupTextoCurso: formulario.cabeceraMensajeSupTextoCurso,
            cabeceraMensajeSupTextoWhitepaper: formulario.cabeceraMensajeSupTextoWhitepaper,
            ...
            cabeceraMensajeTextoWhitepaper: formulario.cabeceraMensajeTextoWhitepaper,
            ...
            cabeceraMensajeInfTextoWhitepaper: formulario.cabeceraMensajeInfTextoWhitepaper,
            ...
            cuerpoMensajeSupIndexCurso: formulario.cuerpoMensajeSupIndexCurso,
            cuerpoMensajeSupTexto: formulario.cuerpoMensajeSupTexto,
            cuerpoMensajeSupTextoCurso: formulario.cuerpoMensajeSupTextoCurso,
            cuerpoMensajeSupTextoWhitepaper: formulario.cuerpoMensajeSupTextoWhitepaper,
